...
const [seed, styles, client, page, social, logo, logoutIcon, refreshIcon, downloadIcon, exports, index] = await Promise.all([
...
const bundled = [
  ...
  // The production guide is excluded because it contains live pilot screenshots.

...
const SEED_VERSION = "workbook-order-v4-full-parks-and-development";
const DIRECTORY_SEED_VERSION = "bill-email-directory-v5-runtime-compatible-passwords";
...
const USER_DIRECTORY_SEED = [
  ...
  { first_name: "James", last_name: "Obletz", user_email: "JObletz@delawarenorth.com", role: "viewer" },
  { first_name: "Scott", last_name: "Socha", user_email: "SSocha@delawarenorth.com", role: "viewer" },
  { first_name: "Jeffrey", last_name: "Taips", user_email: "JTAIPS@delawarenorth.com", role: "viewer" },
  { first_name: "Gwilym", last_name: "Brick", user_email: "GBrick@delawarenorth.com", role: "viewer" },
  { first_name: "Gage", last_name: "Lanning", user_email: "GLanning@delawarenorth.com", role: "viewer" },
  { first_name: "Matthew", last_name: "Skinner", user_email: "MSkinner@delawarenorth.com", role: "viewer" },
  { first_name: "Brian", last_name: "Sterner", user_email: "BSTERNER@delawarenorth.com", role: "viewer" },
  { first_name: "Dawn", last_name: "Aparicio", user_email: "DAPARICI@delawarenorth.com", role: "viewer" },
  { first_name: "Louis", last_name: "Piuggi", user_email: "LPiuggi@delawarenorth.com", role: "viewer" },
  { first_name: "Kelly", last_name: "Cody", user_email: "KCody@delawarenorth.com", role: "viewer" },
  { first_name: "Wesley", last_name: "Trump", user_email: "WTrump@delawarenorth.com", role: "viewer" },
  { first_name: "Thomas", last_name: "Barney", user_email: "TBarney@delawarenorth.com", role: "viewer" },
  { first_name: "Elizabeth", last_name: "MacDonald", user_email: "EMacDona@delawarenorth.com", role: "viewer" },
  { first_name: "Dhruv", last_name: "Srivastava", user_email: "DSrivastava@delawarenorth.com", role: "viewer" },
  { first_name: "Dawn", last_name: "Hedges", user_email: "DHedges@delawarenorth.com", role: "viewer" },
  { first_name: "Eliot", last_name: "Hermanson", user_email: "EHermanson@delawarenorth.com", role: "viewer" },
  { first_name: "Beth", last_name: "Salansky", user_email: "BSalansk@delawarenorth.com", role: "viewer" },
  { first_name: "Alyssa", last_name: "Leman", user_email: "AOrtiz@delawarenorth.com", role: "viewer" },
  { first_name: "Nikki", last_name: "Hueckel", user_email: "NHueckel@delawarenorth.com", role: "viewer" },
  { first_name: "Dana", last_name: "Pellicano", user_email: "DPellicano@delawarenorth.com", role: "viewer" },
  { first_name: "Kevin", last_name: "Miller", user_email: "KMiller8@delawarenorth.com", role: "viewer" },
  { first_name: "Seth", last_name: "Rose", user_email: "srose@patinagroup.com", role: "viewer", company: "Patina Restaurant Group" },
  { first_name: "Olivier", last_name: "Rassinoux", user_email: "ORassinoux@patinagroup.com", role: "viewer", company: "Patina Restaurant Group" },
  { first_name: "Melissa", last_name: "Cendrowski", user_email: "MCendrowski@delawarenorth.com", role: "viewer" },
  { first_name: "Brent", last_name: "Haven", user_email: "BHaven@delawarenorth.com", role: "viewer" },
  { first_name: "Bill", last_name: "Nielsen", user_email: "BNielsen@delawarenorth.com", role: "admin" },
  { first_name: "Joe", last_name: "Quagliana", user_email: "JQuaglia@delawarenorth.com", role: "editor" },
  { first_name: "David", last_name: "Ruede", user_email: "DRuede@patinagroup.com", role: "editor", company: "Patina Restaurant Group" },
  { first_name: "Debbie", last_name: "Friedel", user_email: "DFRIEDEL@delawarenorth.com", role: "viewer" },
  { first_name: "Francine", last_name: "Booth", user_email: "FBooth@delawarenorth.com", role: "viewer" },
  { first_name: "Annmarie", last_name: "Vanini", user_email: "AVanini@delawarenorth.com", role: "viewer" },
  { first_name: "Kara", last_name: "Vogel", user_email: "KBorowia@delawarenorth.com", role: "viewer" },
  { first_name: "Denise", last_name: "Gabala", user_email: "DGabala@delawarenorth.com", role: "viewer" },
  { first_name: "Angie", last_name: "Long", user_email: "ALong@patinagroup.com", role: "viewer", company: "Patina Restaurant Group" },
  { first_name: "Eric", last_name: "Fraas", user_email: "EFraas@delawarenorth.com", role: "viewer" },
  { first_name: "Chris", last_name: "O'Malley", user_email: "COmalley@delawarenorth.com", role: "viewer" },
  { first_name: "Junette", last_name: "Diaz", user_email: "JDiaz@delawarenorth.com", role: "viewer" },
  { first_name: "Mark", last_name: "Coogan", user_email: "MCoogan@delawarenorth.com", role: "viewer" },
  { first_name: "Kevin", last_name: "Keens", user_email: "KKeens@delawarenorth.com", role: "editor" },
  { first_name: "Gregory", last_name: "Dauberger", user_email: "GDauberger@delawarenorth.com", role: "admin" },
  { first_name: "Lori", last_name: "Caballero", user_email: "LCaballe@delawarenorth.com", role: "viewer" },
  { first_name: "Heather", last_name: "Coulter", user_email: "HCoulter@delawarenorth.com", role: "viewer" },
  { first_name: "Sarah", last_name: "Regan", user_email: "SRegan1@delawarenorth.com", role: "viewer" },
  { first_name: "Kate", last_name: "DelGobbo", user_email: "KDelGobbo@delawarenorth.com", role: "viewer" },
  { first_name: "Gianni", last_name: "Barnes", user_email: "GBarnes@delawarenorth.com", role: "viewer" },
  { first_name: "Bridget", last_name: "Rabon", user_email: "BRabon@delawarenorth.com", role: "viewer" },
  { first_name: "Robert", last_name: "Thormeier", user_email: "RTHORME@delawarenorth.com", role: "viewer" },
  { first_name: "David", last_name: "Helms", user_email: "DHelms@delawarenorth.com", role: "viewer" },
  { first_name: "McKayla", last_name: "Vance", user_email: "MVance@delawarenorth.com", role: "viewer" },
  { first_name: "Evan", last_name: "Myers", user_email: "EMyers@delawarenorth.com", role: "viewer" },
  { first_name: "Kathryn", last_name: "Pitillo", user_email: "KPitillo@delawarenorth.com", role: "viewer" },
  { first_name: "Jessica", last_name: "Heary", user_email: "JHeary@delawarenorth.com", role: "viewer" },
  { first_name: "Nicholas", last_name: "DeJoy", user_email: "NDeJoy@delawarenorth.com", role: "viewer" },
  { first_name: "Hope", last_name: "Ray", user_email: "HRay@delawarenorth.com", role: "viewer" },
  { first_name: "Kate", last_name: "Zellefrow", user_email: "KZellefrow@delawarenorth.com", role: "viewer" },
  { first_name: "Keri", last_name: "Shaw", user_email: "KShaw1@delawarenorth.com", role: "viewer" },
  { first_name: "Amber", last_name: "Krawczyk", user_email: "AKrawczyk@delawarenorth.com", role: "viewer" },
  { first_name: "Erin", last_name: "Benike", user_email: "EBenike@delawarenorth.com", role: "viewer" },
  { first_name: "Jason", last_name: "Fatouros", user_email: "JFatouros@delawarenorth.com", role: "viewer" },
  { first_name: "Michael", last_name: "Darrow", user_email: "MDarrow@delawarenorth.com", role: "viewer" },
  { first_name: "Michael", last_name: "Ilacqua", user_email: "MIlacqua@delawarenorth.com", role: "viewer" },
  { first_name: "Robert", last_name: "Bradfield", user_email: "RBradfield@delawarenorth.com", role: "viewer" },
  { first_name: "Shawn", last_name: "Mattox", user_email: "SMATTOX@delawarenorth.com", role: "viewer" },
  { first_name: "Tim", last_name: "Brown", user_email: "TBrown13@delawarenorth.com", role: "editor", title: "Senior Director - Gaming" },
  { first_name: "Thomas", last_name: "Long", user_email: "TLong@delawarenorth.com", role: "viewer" },
  { first_name: "Chynna", last_name: "Barron", user_email: "CBarron@delawarenorth.com", role: "editor" },
  { first_name: "Tom", last_name: "Lagos", user_email: "TLagos@delawarenorth.com", role: "admin", title: "Sr. Project Manager - Design & Construction" },
  { first_name: "Maxwell", last_name: "Muzorewa", user_email: "MMuzorewa@delawarenorth.com", role: "admin" },
  { first_name: "John", last_name: "Kolkowski", user_email: "JKolkowski@delawarenorth.com", role: "editor" },
  { first_name: "Madeline", last_name: "Cala", user_email: "MCala@delawarenorth.com", role: "admin" },
  { first_name: "Matthew", last_name: "Nowakowski", user_email: "MNowakowski@delawarenorth.com", role: "editor" },
];
// Contractor export: legacy pilot credential records intentionally omitted.
// Provision fresh approved accounts after initial database seeding.
...
// Run this immediately before the corresponding UPDATE in the same D1 batch.
// Column names come only from the route's editable-field allowlist. Reading the
...
function fieldAuditStatement(db, user, projectId, action, table, fields, values) {
  ...
  return db.prepare(`
    ...
    SELECT ?, 'project', ?, ?, ?, json_object(
      'version', 1,
      'projectName', (SELECT name FROM projects WHERE id = ?),
      'actorName', ?,
      'changes', json((SELECT json_group_array(json_object(
...
async function ensureDirectorySeed(db) {
  ...
  const statements = USER_DIRECTORY_SEED.flatMap((person) => {
    ...
    const note = "Imported from Bill Nielsen's August 31, 2026 Design & Construction report email.";
...
async function handleApi(request, env, url) {
  ...
  if (request.method === "PATCH" && fieldsMatch) {
    ...
    sets.push("updated_at = datetime('now')");
    const statements = [
      fieldAuditStatement(env.DB, user, projectId, "field_update", "projects", fields, values),
      env.DB.prepare("UPDATE projects SET " + sets.join(", ") + " WHERE id = ?")
        .bind(...values, projectId),
    ];
